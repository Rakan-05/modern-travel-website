...
const Nav = ({ openNav }: Props) => {
    ...
    return (
        <div className={`${navBg ? "bg-blue-950 shadow-md" : "fixed"} transition-all duration-200 h-[12vh] z-1000 fixed w-full`}>
            <div className='flex items-center h-full justify-between w-[90%] xl:2-[80%] mx-auto'>
                {/* LOGO */}
                ...
                <div className="flex items-center space-x-4">
                    <button className=' cursor-pointer md:px-12 md:py-2.5 px-8 py-2 text-black text-base bg-white hover:bg-gray-200 hover:text-blue-500 transition-all duration-200 rounded-lg'>Book Now</button>
                    {/*Burger menu*/}
